...
# of pages that fit in DRAM
# of pages that fit in NVM
# of pages that fit in SSD
# of pages that fit in HDD

Durable pages: (Must be written back to NVM/SSD/HDD)
...
Ephemeral pages: (Need not be written back to durable storage)
